...
import view.view4info.vibration.ViewSwitchVibration;
import view.view4info.vibration.ViewSwitchVibrationSetTips;
import view.view4info.vibration.ViewSwitchVibrationSetTxt;
...
//                return (new ViewUserInfo(parent, null));
            ...
            case R.layout.view_me_switch_vibration:
                return (new ViewSwitchVibration(parent, null));
            ...
            case R.layout.view_me_switch_vibration_txt:
                return (new ViewSwitchVibrationSetTxt(parent, null));
            case R.layout.view_me_switch_vibration_tips:
                return (new ViewSwitchVibrationSetTips(parent, null));
