...
public class AdapterShowGpsPathCollect extends BaseAdapter {
    ...
    public AdapterShowGpsPathCollect(Context context,int mRightWidth, List<DataGpsPath> listPath) {
    ...
    public void click(final ViewHolder holder, final int position) {
        holder.pathshare.setOnClickListener(new OnClickListenerMy() {
            ...
            public void onClickNoFast(View v) {
                ...
                OToastSharePath.getInstance().show(holder1.pathshare, "sharepath005", new OToastSharePath.OnClickButtonListener(){
                    @Override
                        ...
                        .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                            ...
                            public void onClickConfirm(boolean isClickConfirm) {
                                ...
                                if (isClickConfirm) {
                                    ...
                                    OCtrlGps.getInstance().ccmd1244_GPSAreaCollect(carId, list.get(position).ide, 0, 20, list.get(position).isCollect);
                                }
                            }
                        }).show();
            }
...
//        });
    ...
    public final class ViewHolder {
        ...
        public View item_left , middle_layout, layout_black_bg;
        public long ide;
    }
}
