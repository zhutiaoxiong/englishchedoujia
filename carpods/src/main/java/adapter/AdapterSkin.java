...
public class AdapterSkin extends BaseAdapter {
    ...
    public void startDownLoad(final int skinId, String url) {
        ...
        currentDownLoadItem.btn_setup.setText(ResourceUtil.getResourceStr(mContext,R.string.page_dreup_downloading));
...
//                        currentDownLoadItem.btn_setup.setProgress(soFarBytes);
                    ...
                    protected void completed(BaseDownloadTask task) {
                        ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, ResourceUtil.getResourceStr(mContext,R.string.page_dreup_download_successful));
                        ODBHelper.getInstance(mContext).changeCommonInfo("IsDownLoadZip" + skinId, "true");
                        //下载完变设置
                        currentDownLoadItem.btn_setup.setText(ResourceUtil.getResourceStr(mContext,R.string.set));
                    ...
                    protected void error(BaseDownloadTask task, Throwable e) {
                        ...
                        ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST,  ResourceUtil.getResourceStr(mContext,R.string.page_dreup_download_failed));
                        currentDownLoadItem.btn_setup.setProgress(0);
                        currentDownLoadItem.btn_setup.setText( ResourceUtil.getResourceStr(mContext,R.string.page_dreup_Reload));
                        currentDownLoadItem.btn_setup.setClickable(true);
                    }
                    @Override//已存在相同下载
