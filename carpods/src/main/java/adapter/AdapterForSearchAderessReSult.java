...
public class AdapterForSearchAderessReSult extends BaseAdapter {
    private Context       context;
    private List<DataPos> list;
    private OnClickListener onClickListener;

    public AdapterForSearchAderessReSult(Context context,List<DataPos> allPoi,OnClickListener listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Pattern p = Pattern.compile(ViewHomePosChoose.searchStr);
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(onClickListener!=null)onClickListener.onClickChoosePoint(data,position);
            }
        });
        return convertView;
    }
    ...
    public interface OnClickListener {
        void onClickChoosePoint(DataPos data,int position);
    }
