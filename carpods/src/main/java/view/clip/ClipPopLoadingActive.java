...
public class ClipPopLoadingActive {
    ...
    // ========================out======================
    private static ClipPopLoadingActive _instance;

    public static ClipPopLoadingActive getInstance() {
        if (_instance == null)
            _instance = new ClipPopLoadingActive();
        return _instance;
    }
    ...
    public void show(View parentView) {
        ...
        thisView = (RelativeLayout) layoutInflater.inflate(R.layout.clip_pop_loading_active, null);
...
//        popContain.dismiss();
    ...
    class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 16595:
                    if(thisView == null || parentView == null || !parentView.isAttachedToWindow())return;
