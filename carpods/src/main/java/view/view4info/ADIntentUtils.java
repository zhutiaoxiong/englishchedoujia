    ...
    private boolean shouldOverrideUrlLoadingByAppInternal(WebView view, String url, boolean interceptExternalProtocol) {
        ...
        try {
            intent = Intent.parseUri(url, Intent.URI_INTENT_SCHEME);
             ...
             if (BuildConfig.DEBUG) Log.e(TAG, "URISyntaxException: " + e.getLocalizedMessage());
        ...
        try {
            mActivity.startActivity(intent);
             ...
             if (BuildConfig.DEBUG) Log.e(TAG, "ActivityNotFoundException: " + e.getLocalizedMessage());
            return interceptExternalProtocol;
        }
        return true;
    }
        ...
        if (packagename != null) {
            ...
            try{
                mActivity.startActivity(intent);
                 ...
                 if (BuildConfig.DEBUG) Log.e(TAG, "tryHandleByMarket ActivityNotFoundException: " + e.getLocalizedMessage());
                return false;
            }
            return true;
        } else {
