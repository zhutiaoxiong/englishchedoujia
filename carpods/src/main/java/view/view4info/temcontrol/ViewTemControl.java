                ...
                myHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!getCardMessageBack) {
                            ...
                            ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST,  ResourceUtil.getResourceStr(getContext(),R.string.page_tem_control_cant_get_info));
                        }
                    }
                }, 5000);
    ...
    protected void initViews() {
        ...
        temControlAdapter.setOnItemClickListener(new ViewTemControlRecycleViewAdapter.OnItemClickListener() {
            ...
            public void centerTxtClick(View view, int position) {
                ...
                OToastInput.getInstance().showInput(title_head, ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_edit_card_name), ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_edit_card_name), new String[]{OToastInput.OTHER_TEXT}, "nfcname", ViewTemControl.this);
            }
            @Override
            public void rightTxtClick(View view, int position) {
                ...
                if (data.get(position).status.equals("0")) {
                    ...
                    new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                            .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_tem_control_long_info))
                    ...
                    new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                            ...
                            .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_tem_control_delete_top))
                            .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                                @Override
                                public void onClickConfirm(boolean isClickConfirm) {
                                    if (isClickConfirm ) {
    ...
    protected void initEvents() {
        ...
        btn_learn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //添加卡
                new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                        .withTitle( ResourceUtil.getResourceStr(getContext(),R.string.page_tem_control_learn_fuc))
                        .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_tem_control_learn_fuc_tip_info))
                        .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                            @Override
                            public void onClickConfirm(boolean isClickConfirm) {
                                if (isClickConfirm ) {
