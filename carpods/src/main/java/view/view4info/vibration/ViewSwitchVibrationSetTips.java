...
public class ViewSwitchVibrationSetTips extends RelativeLayoutBase {
    private ClipTitleMeSet title_head;
    private TextView text_set;

    public ViewSwitchVibrationSetTips(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.view_me_switch_vibration_tips, this, true);
