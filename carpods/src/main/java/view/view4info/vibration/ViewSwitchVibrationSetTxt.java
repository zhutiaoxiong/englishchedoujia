...
public class ViewSwitchVibrationSetTxt extends RelativeLayoutBase {
    private ClipTitleMeSet title_head;
    private TextView text_set;

    public ViewSwitchVibrationSetTxt(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.view_me_switch_vibration_txt, this, true);
