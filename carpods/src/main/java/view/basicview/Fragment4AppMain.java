...
//        }
    ...
    private void searchLocation(){
        ...
        if( ActivityKulalaMain.getPAGEPOS() == 1
            ...
            txt_address_name.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_no_dingwei));//显示车位置
    ...
    public void onResume() {
        ...
        if(FragmentActionBar.currentPos == 1) {
            ...
            if (currentCar == null || currentCar.ide == 0) {
                myHandler.obtainMessage(HANDLE_SETTO_NO_CAR).sendToTarget();
                ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, ResourceUtil.getResourceStr(getContext(),R.string.did_not_choose_the_vehicle));
                return;
            }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case HANDLE_SETTO_NO_CAR://无车的显示
                    txt_address_name.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_no_dingwei));
                    txt_address.setText("");
                                            ...
                                            public void onCurrentPosGet(final DataPos posData) {
                                                ...
                                                getActivity().runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        txt_address.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_aiche_junin) + dis+"\t\t\t"+address.address);//取了位置再设一次
        ...
        if(car!=null){
            if(car.isActive==0){
                ...
                if(car.isMyCar==0){
                    ...
                    fuchezhu_view.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_fuchezhu_wuquan));
                }else{
                    if(EquipmentManager.isMini()){
                        master_layout.setVisibility(View.INVISIBLE);
                        fuchezhu_view.setVisibility(View.INVISIBLE);
...
//                    fuchezhu_view.setText("当前设备不支持");
        ...
        map_view.setOnClickShareListener(new FullScreenMap.OnClickShareListener() {
            ...
            public void onClickShare(final DataCarTime dataCarTime) {
                ...
                shareUrlSearch.setOnGetShareUrlResultListener(new OnGetShareUrlResultListener() {
                    ...
                    public void onGetLocationShareUrlResult(ShareUrlResult result) {
                        ...
                        OToastSharePath.getInstance().show(txt_address_name, ResourceUtil.getResourceStr(getContext(),R.string.share),
            ...
            public void onClickNavi(DataCarTime dataCarTime) {
                ...
                if(list==null||list.size()==0){
                    Toast.makeText(GlobalContext.getContext(), ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_nishangweianzhuang), Toast.LENGTH_SHORT).show();
                }else{
                    String[] str = new String[list .size()];  //创建一个String型数组
                    list.toArray(str); //将List数组转为String数组
                    OToastButtonBlackStyle.getInstance().show(map_view,str , "navito", Fragment4AppMain.this, ResourceUtil.getResourceStr(getContext(),R.string.navigation));
                }
            }
        });
    }
    ...
    private void goBaiduMap(Context context, double latitude, double longtitude, String address) {
        if (isInstallApk(context, "com.baidu.BaiduMap")) {
            ...
            Toast.makeText(context, ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_nishangweianzhuang_baodu), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private  List<String> getFinalList(){
        ...
        if(isInsTallBaidu()&&isInsTallGaode()&&isInsTallTenxun()){
            list.add(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_tengxun_daohang));
            list.add(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_baidu_daohang));
            list.add(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_gaode_daohang));
    ...
    public void callback(String key, Object value) {
        if (key.equals("navito")) {
            ...
            if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_baidu_daohang))) {
            ...
            } else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_gaode_daohang))) {
...
//                        .append("&style=").append(2);
            ...
            } else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_ditu_tengxun_daohang))) {
                LatLng endPoint = BD2GCJ(new LatLng(cacheDataCartime.carPos.latitude, cacheDataCartime.carPos.longitude));//坐标转换
