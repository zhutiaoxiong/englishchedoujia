...
public class AdapterForNaviHistory extends BaseAdapter{
    private Context       context;
    private List<DataPos> list;
    private OnClickItemListener onClickListener;
    private  int deleteBtnWidth;
    public AdapterForNaviHistory(Context context,int deleteBtnWidth, List<DataPos> allPoi,OnClickItemListener listener) {
