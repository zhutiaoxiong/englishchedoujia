...
public class LcdBlueScanner {
    ...
    //==================================================
    private static LcdBlueScanner _instance;
    protected LcdBlueScanner() {
    }
    public static LcdBlueScanner getInstance() {
        if (_instance == null)
            _instance = new LcdBlueScanner();
        return _instance;
    }
    //=========================初始化=========================
