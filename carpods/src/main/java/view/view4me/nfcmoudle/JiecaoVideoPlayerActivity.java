...
public class JiecaoVideoPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ManagerPublicData.nfcInfo.equals("1")){
            title_head.txt_title_show.setText(ResourceUtil.getResourceStr(this,R.string.page_nfc_add_nfc_phone_title));
        }else{
            title_head.txt_title_show.setText(ResourceUtil.getResourceStr(this,R.string.page_nfc_add_nfc_card_title));
        }
...
//                String s4 = "http://manage.kcmoco.com/app/baika.mp4";
                switch (i) {
                    case 0:
                        datas.add(new VedeoBean(s1, R.drawable.img_nfc_set_huawei, ResourceUtil.getResourceStr(this,R.string.page_nfc_huawei)));
                        break;
                    case 1:
                        datas.add(new VedeoBean(s2, R.drawable.img_nfc_set_opvivo,ResourceUtil.getResourceStr(this,R.string.page_nfc_oppo)));
                        break;
//                    case 2:
...
//                        break;
            ...
            datas.add(new VedeoBean(s5, R.drawable.img_nfc_set_haoh, ResourceUtil.getResourceStr(this,R.string.page_nfc_add_nfc_card_title)));
        }
