...
public class ViewNfc extends RelativeLayoutBase {
    ...
    private Button id_manager;
    private View zhanweiview;
    private TextView txtset,txtsett;
    ...
    private final Handler myHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
            if (msg.what == 11111) {
                ...
                case 1:
                    ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_success));
                    break;
                case 2:
                    ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST,  ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_fail));
                    break;
                ...
                myHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!getCardMessageBack) {
                            ...
                            ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_get_fail));
                        }
                    }
                }, 5000);
    ...
    public ViewNfc(Context context, AttributeSet attrs) {
        super(context, attrs);//this layout for add and edit
        LayoutInflater.from(context).inflate(R.layout.view_me_nfc, this, true);
    ...
    protected void initViews() {
        data = new ArrayList<>();
        List<NfcData> myList=ManagerNfc.getInstance().createinitICList();
        data=myList;
        ...
        if (nfcAdapter == null) {
            nfcAdapter = new ViewNFCRecycleViewAdapter(data, getContext(),0);
        ...
        nfcAdapter.setOnItemClickListener(new ViewNFCRecycleViewAdapter.OnItemClickListener() {
            ...
            public void centerTxtClick(View view, int position) {
                ...
                OToastInput.getInstance().showInput(title_head, "", ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_edit_card_name), new String[]{OToastInput.OTHER_TEXT}, "nfcname", ViewNfc.this);
            }
            @Override
            public void rightTxtClick(View view, int position) {
                ...
                if (data.get(position).status.equals("0")) {
                    ...
                    new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                            ...
                            .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_tip_add))
                            .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                                ...
                                public void onClickConfirm(boolean isClickConfirm) {
                                    if (isClickConfirm ) {
                                        //写卡
                                        isOpretion=true;
                                        OCtrlCar.getInstance().ccmd2102_addOrDeleteNfc(ManagerCarList.getInstance().getCurrentCarID(), getCardFromPosition(), "03");
                    ...
                    new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                            .withTitle(ResourceUtil.getResourceStr(getContext(),R.string.the_tip))
                            .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_tip_delete))
                            .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                                @Override
                                public void onClickConfirm(boolean isClickConfirm) {
                                    if (isClickConfirm ) {
    ...
    protected void initEvents() {
        ...
        id_manager.setOnClickListener(new OnClickListenerMy5000() {
            ...
            public void onClickNoFast(View view) {
                new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                        .withTitle(ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_tip_and_info))
                        .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_tip_id))
                        .withButton("",ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_know))
                        .withClick(new ToastConfirmNormal.OnButtonClickListener() {
                            @Override
                            public void onClickConfirm(boolean isClickConfirm) {
                                if (isClickConfirm ) {
    ...
    protected void invalidateUI() {
        if (ManagerNfc.getInstance().getNfcDataForView() != null) {
            data = ManagerNfc.getInstance().getNfcDataForView();
            nfcAdapter.setData(data);
            nfcAdapter.notifyDataSetChanged();
        }
    }
