    ...
    protected void initViews() {
        ...
        nfcAdapter.setOnItemClickListener(new ViewNFCRecycleViewAdapter.OnItemClickListener() {
            ...
            public void centerTxtClick(View view, int position) {
                ...
                OToastInput.getInstance().showInput(title_head, "",  ResourceUtil.getResourceStr(getContext(),R.string.page_nfc_blue_edit_card_name), new String[]{OToastInput.OTHER_TEXT}, "nfcname", ViewNfcId.this);
            }
            @Override
