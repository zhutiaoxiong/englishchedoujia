...
//        }
    ...
    public void initEvents() {
        ...
        txt_vin.img_right.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
...
//                    getContext().startActivity(intent);
        ...
        btn_confirm.setOnClickListener(new OnClickListenerMy() {
            ...
            public void onClickNoFast(View view) {
                ...
                if(TextUtils.isEmpty(carName) || carName.length()<6)
                {
                    new ToastTxt(GlobalContext.getCurrentActivity(),null,false).withInfo(getResources().getString(R.string.page_car_modofy_chapai_six)).quicklyShow();
...
//                }
                ...
                new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                        .withTitle(getResources().getString(R.string.modify_the_vehicle))
                        .withInfo(getResources().getString(R.string.sure_to_modify)+data.num +getResources().getString(R.string.de_information))
