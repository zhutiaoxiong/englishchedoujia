...
//                Log.e("蓝牙gps","绑定MINI蓝牙gps已打开，蓝牙未打开");
                txt_text.setText(getResources().getString(R.string.page_car_need_bind_blue));
...
//                Log.e("蓝牙gps","绑定MINI蓝牙gps均未打开");
                txt_text.setText(getResources().getString(R.string.page_bind_need_blue_gps));
                lin_shows.setVisibility(View.VISIBLE);
                switchState=1;
            }else{
                txt_text.setText(getResources().getString(R.string.page_car_need_gps));
    ...
    public void initEvents() {
        ...
        btn_confirm.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               if(btn_confirm.getText().toString().equals(getResources().getString(R.string.page_car_detail_jihuo))) {
                    if(!TextUtils.isEmpty(input_code.getText().toString())){
                        if(input_code.getText().toString().startsWith("MIN")||input_code.getText().toString().startsWith("NFC")){
                            ...
                            if (blueDeviceName.length() == 0) {
                                ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, getResources().getString(R.string.page_car_blue_not_enter));
                                return;
                            }
                            ...
                            if(!checkBlueIsInList(blueDeviceName)&&!checkBlueIsInBondList(blueDeviceName)){
                                ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, getResources().getString(R.string.page_car_blue_not_shibie));
                                BlueScanList.getInstance().scanDeviceList(getContext(), true, listenerList);
                                return;
                            }
...
//                            OCtrlBlueTooth.getInstance().ccmd_10002_bind_mini(blueDeviceName,data.ide, MyLocationListener.myCity);//蓝牙名字，ide,所在城市
                            ...
                            new ToastConfirmNormal(GlobalContext.getCurrentActivity(),null,false)
                                    .withTitle(getResources().getString(R.string.page_bind_tip_title))
                                    .withInfo(getResources().getString(R.string.page_bind_tip_info))
                                    .withButton(getResources().getString(R.string.page_bind_tip_caozuo),getResources().getString(R.string.page_bind_tip_zaijihuo))
...
//                                        ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_CONFIRM, dataa);
        ...
        txt_agreement.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString(ActivityWeb.TITLE_NAME,getResources().getString(R.string.page_user_agreement));
                String address;
                try {
                    ...
                    address = "http://manage.kcmoco.com/protocol_cdj.html";
...
//            handleChangeData();
            ...
            ODispatcher.dispatchEvent(OEventName.ACTIVITY_KULALA_GOTOVIEW, R.layout.carman_main);
            ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, getResources().getString(R.string.page_car_blue_jihuochenggong));
        }
    }
    ...
    public void invalidateUI() {
        if (data == null) {
            ...
            txt_model_state.setText(getResources().getString(R.string.page_bind_tip_please_xian_jihuo));
            txt_intro.setText(getResources().getString(R.string.page_bind_tip_please_jihuomashishenme));
            ...
            if(TextUtils.isEmpty(equipmentNunber)){
                input_code.setHint(getResources().getString(R.string.page_bind_tip_please_inpit_jihuoma));
            }else{
            ...
            switch (msg.what) {
                ...
                case 326:
                    ...
                    if(img_check.isSelected() && input_code.getText().toString().length()>0){
                        btn_confirm.setText(getResources().getString(R.string.page_car_detail_jihuo));
                    ...
                    break;
                case 327 :
                    if (BuildConfig.DEBUG)Log.e("拿他妈的车列表", "准备回车列表页面");
                    ClipPopLoadingActive.getInstance().show(title_head);
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            if (BuildConfig.DEBUG)Log.e("拿他妈的车列表", "回车列表页面");
