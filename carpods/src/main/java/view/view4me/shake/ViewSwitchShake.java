...
//        img_blue_vibration_cover = (ImageView) findViewById(R.id.img_blue_vibration_cover);
    ...
    public void initViews() {
        msp=new SpannableString(ResourceUtil.getResourceStr(getContext(),R.string.page_shake_small_tips));
        //设置字体前景色
...
//        tv_content.setText();
    ...
    public void initEvents() {
        ...
        shake_level_set.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                OToastButtonBlackStyle.getInstance().show(title_head, new String[]{"最重","重", "中", "轻","最轻","最最轻"}, "item_shake_level", ViewSwitchShake.this, "摇一摇力度设置");
                OToastButtonBlackStyle.getInstance().show(title_head, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_shake_most),ResourceUtil.getResourceStr(getContext(),R.string.page_shake_heavy), ResourceUtil.getResourceStr(getContext(),R.string.page_shake_middle), ResourceUtil.getResourceStr(getContext(),R.string.page_shake_light)}, "item_shake_level", ViewSwitchShake.this,ResourceUtil.getResourceStr(getContext(),R.string.page_shake_set_up) );
            }
        });
        ...
        img_blueswitch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isHaveShakeSensor) {
                    Toast.makeText(getContext(), ResourceUtil.getResourceStr(getContext(),R.string.page_shake_no_sencher), Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                        img_blue_vibration_cover.setVisibility(INVISIBLE);
                        ...
                        String shakeLevel=BlueLinkNetSwitch.getShakeLevel();
                        if(TextUtils.isEmpty(shakeLevel)){
                            shake_level_set.txt_bottom.setText("middle");
                        }else{
                            shake_level_set.txt_bottom.setText(shakeLevel);
                        }
