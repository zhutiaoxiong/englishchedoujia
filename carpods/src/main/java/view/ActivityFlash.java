...
//            LoadPermissions.getInstance().loadPermissionAll(ActivityFlash.this);
    ...
    private void txtSet(){
        t3.setText("Before using our products and services, please read and understand");
        SpannableString clickString = new SpannableString("《User Service Agreement》");
        ...
        t3.append(new SpannableString("and"));
        ...
        t3.append(new SpannableString("as well as"));
        SpannableString clickString3 = new SpannableString("《Permission Description》");
...
//                             if (BuildConfig.DEBUG) Log.e("ActivityFlash", "网络不良");
                            new ToastConfirmNormal(ActivityFlash.this, null,false)
                                    .withTitle("prompt")
                                    .withInfo("Poor network, please open WiFi or data connection")
