            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (adapter.getItem(position).ide == 1) {
                    ...
                    new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                            .withTitle(getResources().getString(R.string.tip))
                            .withInfo(getResources().getString(R.string.will_send_a_change_password_link_to_your_binding_mailbox_sure))
        ...
        if (s.equals(OEventName.SECRETINFOS_RESULTBACK)) {
            ...
            if (mess == null || mess.equals("")) {
                ...
                new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                        .withTitle(getResources().getString(R.string.tip))
                        .withInfo(mess)
                        .withButton("",getResources().getString(R.string.confirm))
                        .show();
            }
        }
    }
