    ...
    private void setLockOrUnLockLevelUI() {
        if (EquipmentManager.isMinJiaQiang()) {
            ...
            if(lockUnlockLevel==0){
                lock_unlock_settings.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_lock_txt));
            }else  if(lockUnlockLevel==1){
                lock_unlock_settings.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_lock_txt));
            }else  if(lockUnlockLevel==2){
                lock_unlock_settings.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_txt));
            }
        }
    }
    ...
    private void setEvasiveDeviceLevelUI() {
        if (EquipmentManager.isMini()||EquipmentManager.isMinJiaQiang()||EquipmentManager.isShouweiSix()) {
            ...
            if(evasiveDeviceMiniLevel==0){
                mini_evasive_device.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_unlock_tong));
            }else  if(evasiveDeviceMiniLevel==1){
                mini_evasive_device.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_caijiaosha_tong));
            }
            pushToServer();
        }
    }
...
//                        Log.e("是否改变", "一样");
        ...
        recover_factory.setOnClickListener(v -> new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                .withTitle(ResourceUtil.getResourceStr(getContext(),R.string.the_tip))
                .withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_project_factory_tip))
        ...
        open_trunk_way.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_nine),ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven),ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five),ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three),ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three), ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two)}, "open_trunk_way", ViewProSet.this,  ResourceUtil.getResourceStr(getContext(),R.string.page_project_open_truck_way));
...
//                }
        ...
        trumpet_switch_level.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_highest), ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_high), ResourceUtil.getResourceStr(getContext(),R.string.page_shake_middle),  ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_low)}, "labayinliang", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_laba));
...
//                }
        ...
        item_upwindow_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"15s", "10s", "5s"}, "item_up_window", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_up_time));
            }
        });
        item_evasive_pass_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"1500ms","1300ms","1000ms", "900ms", "800ms", "700ms", "600ms", "500ms", "400ms", "300ms"}, "item_evasive_pass", ViewProSet.this,  ResourceUtil.getResourceStr(getContext(),R.string.page_project_huibiqi_tong_time));
            }
        });
        item_evasive_close_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"1000ms", "900ms", "800ms", "700ms", "600ms", "500ms", "400ms", "300ms"}, "item_evasive_close", ViewProSet.this,  ResourceUtil.getResourceStr(getContext(),R.string.page_project_huibiqi_duan_time));
            }
        });
        item_evasive_control_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"1000ms", "900ms", "800ms", "700ms", "600ms", "500ms", "400ms", "300ms"}, "item_evasive_control", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_huibiqi_control_time));
            }
        });
        item_evasive_control_way.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two), ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control)}, "item_evasive_control_way", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_huibiqi_control_way));
            }
        });
        ...
        lock_trigger_way.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two), ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control)}, "lock_triger_way", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_lock_chufa));
            }
        });
        ...
        unlock_trigger_way.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two), ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control)}, "unlock_triger_way", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_unlock_chufa));
            }
        });
        ...
        up_window_delay_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"1000ms", "900ms", "800ms", "700ms", "600ms", "500ms","0ms"}, "up_window_interver_time", ViewProSet.this,  ResourceUtil.getResourceStr(getContext(),R.string.page_project_up_delay_time));
            }
        });
        lock_unlock_settings.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_txt), ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_lock_txt), ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_lock_txt)}, "lock_unlock_level_set", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_setting_txt));
            }
        });
        mini_evasive_device.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_caijiaosha_tong), ResourceUtil.getResourceStr(getContext(),R.string.page_project_unlock_tong)}, "evasive_device_mini", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_project_huibiqi_control));
            }
        });
        findcar_way.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven),ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five),ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three),ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three), ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two), ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_duanan_one), ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_laba)}, "find_car_wayy", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way));
            }
        });
        findcar_jiange_time.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                OToastButtonBlackStyle.getInstance().show(title, new String[]{"1000ms", "900ms", "800ms", "700ms", "600ms", "500ms"}, "find_car_jiangee_time", ViewProSet.this, ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_jiange_time));
            }
        });
    }
...
//                        Log.e("是否改变", "第一次");
            ...
            if(isSuccess){
                new ToastTxt(GlobalContext.getCurrentActivity(), null, false).withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_project_factory_success)).quicklyShow();
                if (timerTask != null) {
                    timerTask.cancel();
                    timerTask = null;
                }
                ...
                new ToastTxt(GlobalContext.getCurrentActivity(), null, false).withInfo(ResourceUtil.getResourceStr(getContext(),R.string.page_project_factory_fail)).quicklyShow();
            }
    ...
    public void callback(String key, Object value) {
        if (key.equals("open_trunk_way")) {
            ...
            if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two))) {
                sendTruckOpenLianAn(2);
//                sendTruckOpen(2);
//                BlueLinkReceiver.getInstance().sendMessage(ByteHelper.bytesToHexString(BlueInstructionCollection.doubleClickOpenTrunk()), false);
            } else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three))) {
                sendTruckOpen(3);
//                BlueLinkReceiver.getInstance().sendMessage(ByteHelper.bytesToHexString(BlueInstructionCollection.longClickOpenTrunk()), false);
            }else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five))) {
                sendTruckOpen(5);
            }else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven))) {
                sendTruckOpen(7);
            }else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_nine))) {
                sendTruckOpen(9);
            }else if (o.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three))) {
...
//                    break;
//            }
            if(oo.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_low))){
                level = 0;
            }else  if(oo.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_shake_middle))){
                level = 1;
            }else  if(oo.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_high))){
                level = 2;
            }else  if(oo.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_highest))){
                level = 3;
            }
            BlueLinkReceiver.getInstance().sendMessage(ByteHelper.bytesToHexString(BlueInstructionCollection.setTrumpetsTime(level)), false);
    ...
    private int getLockUnlockLevel(String value) {
        if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_lock_txt))) {
            return 0;
        } else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_lock_txt))) {
            return 1;
        } else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_start_unlock_txt))) {
            return 2;
        }
        return 0;
    }
    ...
    private int getFindCarWayCount(String value) {
        if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_laba))) {
            return 1;
        } else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_duanan_one))) {
            return 2;
        }else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two))) {
            return 3;
        }else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three))) {
            return 4;
        }else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three))) {
            return 5;
        }else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five))) {
            return 6;
        }else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven))) {
            return 7;
        }
        return 0;
    }
    ...
    private int getEvasiveDeviceMini(String value) {
        if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_unlock_tong))) {
            return 0;
        } else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_caijiaosha_tong))) {
            return 1;
        }
        return 0;
    }
    ...
    private int getEvasiveControlWay(String value) {
        if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control))) {
            return 0;
        } else if (value.equals(ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two))) {
            return 1;
        }
        return 0;
    }
...
//                item_evasive_control_way.setVisibility(View.VISIBLE);
                ...
                cacheProsetData.trunkOpenWith=isTruckOpenMode;
                if (isTruckOpenMode == 0) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two));
                } else   if (isTruckOpenMode == 1) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three));
                }else   if (isTruckOpenMode == 2) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five));
                }else   if (isTruckOpenMode == 3) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven));
                }else   if (isTruckOpenMode == 4) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_nine));
                }else   if (isTruckOpenMode == 32) {
                    open_trunk_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three));
                }

                int istruckLevel = BlueInstructionCollection.getInstance().getTruckLevel();
                cacheProsetData.hornVolume=istruckLevel;
                if (istruckLevel == 0) {
                    trumpet_switch_level.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_low));
                } else if (istruckLevel == 1) {
                    trumpet_switch_level.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_shake_middle));
                } else if (istruckLevel == 2) {
                    trumpet_switch_level.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_high));
                } else if (istruckLevel == 3) {
                    trumpet_switch_level.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_nokey_highest));
                }
    ...
    private void setEvasiveControlWayUI(int level) {
        ...
        pushToServer();
        if (level == 0) {
            item_evasive_control_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control));
        } else if (level == 1) {
            item_evasive_control_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two));
        }
    }
    ...
    private void setLockTrigerWayUI(int level) {
        ...
        if (level == 0) {
            lock_trigger_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control));
        } else if (level == 1) {
            lock_trigger_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two));
        }
        pushToServer();
    }
    ...
    private void setUnLockTrigerWayUI(int level) {
        ...
        if (level == 0) {
            unlock_trigger_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_one_control));
        } else if (level == 1) {
            unlock_trigger_way.txt_bottom.setText(ResourceUtil.getResourceStr(getContext(),R.string.page_project_lianxu_two));
        }
        pushToServer();
    }
    ...
    private void setFindCarWayUI(int level) {
        ...
        switch (level){
            case 0x00:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_laba);
                break;
            case 0x10:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_pro_find_way_duanan_one);
                break;
            case 0x20:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_two);
                break;
            case 0x30:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_project_click_three);
                break;
            case 0x13:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_three);
                break;
            case 0x15:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_five);
                break;
            case 0x17:
                txt=ResourceUtil.getResourceStr(getContext(),R.string.page_project_long_seven);
                break;
        }
