 ...
 */
public class FindViewItem extends RelativeLayout {
    public ImageView img_left;
    public ImageView img_right;
    public TextView txt_center;

    public FindViewItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.find_view_item, this, true);
