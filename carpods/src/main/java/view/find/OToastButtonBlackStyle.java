...
public class OToastButtonBlackStyle {
    ...
    // ========================out======================
    private static OToastButtonBlackStyle _instance;

    public static OToastButtonBlackStyle getInstance() {
        if (_instance == null)
            _instance = new OToastButtonBlackStyle();
        return _instance;
    }
