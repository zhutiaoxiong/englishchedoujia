...
public class ViewControlPanelControl extends LinearLayoutBase {
...
//        }
    ...
    private void showActiveCar() {
        new ToastConfirmNormal(GlobalContext.getCurrentActivity(), null,false)
                .withTitle(getResources().getString(R.string.active_vehicles))
                .withInfo(getResources().getString(R.string.inactive_vehicles_to_activate_it_now))
...
//                        }
                        if(EquipmentManager.isMinJiaQiang()){
                            //跳转nfc界面
                            OToastInput.getInstance().showInput(img_start, getResources().getString(R.string.page_apply_input_password), getResources().getString(R.string.please_enter_a_password), new String[]{OToastInput.PASS}, "stopcheckpassword", ViewControlPanelControl.this);
                        }else{
//                            if (ManagerSwitchs.getInstance().getSwitchConfirms().get(4).isOpen == 1) {
//                                //熄火
                                ClipPopConfirmControl.getInstance().show(img_start, getResources().getString(R.string.title_control_toast_car_off), getResources().getString(R.string.info_control_toast_car_off), "", getResources().getString(R.string.name_car_off), "stopcar", ViewControlPanelControl.this, false);
...
//                            }
                        ...
                        if(EquipmentManager.isMinJiaQiang()){
                            ...
                            if (carStatus.isTheft == 1) {
                                ...
                                //撤防状态下启动
                                ClipPopConfirmControl.getInstance().show(165, img_start, getResources().getString(R.string.title_control_toast_car_on_unlock), getResources().getString(R.string.page_control_zhuyiyouliang), "", getResources().getString(R.string.name_car_on), "startcar", ViewControlPanelControl.this, false);
...
//        });
        img_lock.setMyClickListner(new MyLongClickButton.MyClickListner() {
            ...
            public void onClick() {
                if(EquipmentManager.isMini()&&!EquipmentManager.isShouweiSix()){
                    if(!BlueLinkReceiver.getIsBlueConnOK()){
                        new ToastTxt(GlobalContext.getCurrentActivity(),null,false).withInfo(getResources().getString(R.string.page_control_no_bloetooth_connect)).quicklyShow();
                        return;
                    }
                }
                if(checkSwitchesList())return;
