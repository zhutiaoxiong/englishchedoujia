...
//    private View mParentView;
    ...
    private void setInitUI(){
        if(comand%2==0){
            if(comand==2){
                txt_seat.setText("Driver heating");
            }else if(comand==4){
                txt_seat.setText("Front passenger heating");
            }
        }else{
            if(comand==1){
                txt_seat.setText("Driver ventilation");
            }else if(comand==3){
                txt_seat.setText("Passenger ventilation");
            }
        }
    }
...
//                            OCtrlCar.getInstance().ccmd1253_seat_airheat_control(mCarId,11,getOpenOrClose());
                    ...
                    ODispatcher.dispatchEvent(OEventName.GLOBAL_POP_TOAST, "This function is currently not supported");
