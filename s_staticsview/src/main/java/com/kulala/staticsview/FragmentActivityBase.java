...
import static com.kulala.staticsview.ActivityBase.KEEP_SCREENON;

public abstract class FragmentActivityBase extends FragmentActivity implements OEventObject, OCallBack {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 313:
                    ...
                    if (toast == null) {
                        toast = Toast.makeText(FragmentActivityBase.this, showStr, Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.TOP, 0, ODipToPx.dipToPx(FragmentActivityBase.this, 175));
                        toast.show();
                ...
                case 316:
                    if (loading == null)
                        loading = new ToastLoading(FragmentActivityBase.this, null);
