...
//            Log.i("Shake", "x轴方向的重力加速度" + x + "；y轴方向的重力加速度" + y + "；z轴方向的重力加速度" + z);
            ...
            DataCarBlue carInfo = BlueLinkControl.getInstance().getDataCar();
            if (BuildConfig.DEBUG) Log.e(">>>OShakeBlue>>>", "carInfo.shakeLevel" +carInfo.shakeLevel);
            if(TextUtils.isEmpty(carInfo.shakeLevel)||carInfo.shakeLevel.equals("middle")){
                SPEED_SHRESHOLD=10;
            }else if(carInfo.shakeLevel.equals("light")){
                SPEED_SHRESHOLD=6;
            }
//            else if(carInfo.shakeLevel.equals("最轻")){
//                SPEED_SHRESHOLD=5.5;
//            }else if(carInfo.shakeLevel.equals("最最轻")){
//                SPEED_SHRESHOLD=5;
//            }
            else if(carInfo.shakeLevel.equals("heavy")){
                SPEED_SHRESHOLD=16;
            }else if(carInfo.shakeLevel.equals("most")){
                SPEED_SHRESHOLD=20;
            }
            if (BuildConfig.DEBUG) Log.e(">>>OShakeBlue>>>", "speed:" +SPEED_SHRESHOLD);
