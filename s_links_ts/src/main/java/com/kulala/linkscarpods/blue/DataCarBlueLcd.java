...
public class DataCarBlueLcd {
    ...
    public static void saveLocal(Context context, DataCarBlueLcd car){
        ...
        SharedPreferences settings  = context.getSharedPreferences("carpods_share_blue_lcd", Activity.MODE_MULTI_PROCESS);
        ...
        editor.putLong("isON", car.isON);
        editor.putLong("isTheft", car.isTheft);
        editor.putLong("isLock", car.isLock);
